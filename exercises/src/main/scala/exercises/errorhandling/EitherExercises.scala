...
object EitherExercises {
  ...
  def map4[E, A1, A2, A3, A4, B](fa: Either[E, A1], fb: Either[E, A2], fc: Either[E, A3], fd: Either[E, A4])(
    f: (A1, A2, A3, A4) => B
  ): Either[E, B] = ???
  ...
  def map3[E, A1, A2, A3, B](fa: Either[E, A1], fb: Either[E, A2], fc: Either[E, A3])(
    f: (A1, A2, A3) => B
  ): Either[E, B] = ???
  // 6i. Implement map4
